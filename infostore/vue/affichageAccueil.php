...
<html lang="en">
  ...
  function add(qte,code,prix,name)
  {
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      {var nb= parseInt(document.getElementById("panier").innerHTML);
      ...
      document.getElementById("panier").innerHTML=nb+"";
        ...
        if(this.responseText=="qte9")
        {alert("Quantité supérieur à 9");
  ...
  xhttp.open("GET", "vue/addToCard.php?prod="+code+"&&qte="+qte+"&&prix="+prix+"&&name="+name, true);
  xhttp.send();
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Nous livrons Matériaux Informatiques</h1>
	              <h2 class="subheading mb-4">
						Nous livrons Matériaux Informatiques<h2>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              ...
	              <h2 class="subheading mb-4">
										Nous livrons Matériaux Informatiques </h2>
	              <p><a href="#" class="btn btn-primary">Voir plus de  Details</a></p>
	            </div>
				...
				<div class="row">
							...
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-1.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="index.php?action=pcportable">Ordinateurs portables</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/2.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="index.php?action=pcbureau">Ordinateur de bureau</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="index.php?action=peripherique">Périphérique et Accessoires </a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/1.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="index.php?action=Composants">Composants Informatique</a></h2>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
			...
			?>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="<?php echo $row['image']?>" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span><?php  echo $row[2] ?></span></p>
		    					</div>
	    					</div>
                  ...
                  <div class="m-auto d-flex">
                    ...
                    <span class="buy-now d-flex justify-content-center align-items-center mx-1">
                   <span>
                       <i class='ion-ios-cart'  onclick=

                    <?php   echo "add(1,$row[0],$row[2],'$row[3]')"?> ></i></span>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
            ...
            <span class="price">7Dt <a href="#">à 3Dt seulement</a></span>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Un matériel informatique (en anglais : hardware) est une pièce détachée d'un appareil informatique. Il s'agit d'un domaine important de l’informatique qui va de pair avec le logiciel (software ou firmware). Il peut y avoir des pièces situées à l'intérieur de l'appareil et qui sont indispensables à son fonctionnement, comme secondaires ou disposées à l'extérieur (les périphériques).</p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">InfoStore</h2>
