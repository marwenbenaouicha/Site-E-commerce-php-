...
<html lang="en">
  <head>
    <title>Ordinateurs portables - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
						    <span class="text">NOUS LIVRONS DES MATÉRIAUX INFORMATIQUE</span>
					    </div>
				    </div>
			    </div>
		    </div>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Nous servons des Matériaux Informatiques</h1>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Matériaux Informatiques</h1>
	              <h2 class="subheading mb-4">
										Nous livrons Matériaux Informatiques </h2>
