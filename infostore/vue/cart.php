...
<html lang="en">
 ...
 <body class="goto-here">
    ...
    if ($panier==null)
	 ...
	 {
 foreach($panier as $clef => $val){
$total+=$val[1];

  ?>
                  <tr class="text-center">
                    <td>
					<a href="index.php?action=cart" id="pan"><span class="ion-ios-close" 
					 ></span></a></td>
                    ...
                    <td class="price"><?php echo $val[1] ; ?></td>
...
<?php }?>
			  ...
			  <script>
			  var elements= document.getElementsById('pan');
					for(var i=0; i<elements.length;i++)
					{
					(elements)[i].addEventListener("click", function(){				
					   onclick= <?php unset ($panier[$clef]) ; 
					?> 
					});
					}
			  </script>
        ...
        <div class="row justify-content-end">
          ...
          <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
            ...
            <p><a href="vue/checkout.php" class="btn btn-primary py-3 px-4">Proceed to Checkout</a></p>
          </div>
        </div>
      </div>
    </section>
